...
type SearchFieldType = 'ownerName' | 'supervisorName' | 'supervisorLicense' | 'siteDetailAddress';

/**
 * City Hall Demolition Supervisor Assigned List
 * Shows only SUPERVISOR_ASSIGNED status demolition requests
 */
export function CityDemolitionRecommendationList() {
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-3" style={{ borderTop: '1px solid #D2D2D2', borderBottom: '1px solid #D2D2D2' }}>
            ...
            >
              ...
              <option value="siteDetailAddress">상세주소</option>
            </Select>
